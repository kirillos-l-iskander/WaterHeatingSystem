...
void SW_Init(void)
{
    ...
    SW_G[2].Counter = 0;
    SW_G[2].Lock = 0;
    GPIO_InitPin((((GPIO_TypeDef*)&PORTB)), (0), (1));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTB)), (1), (1));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTB)), (2), (1));
}
...
void SW_Update(void)
{
    ...
    {
        SW_G[0].Lock--;
    }else if(!GPIO_GetPinState((((GPIO_TypeDef*)&PORTB)), (0)))
    {
        SW_G[0].Counter++;
        if(SW_G[0].Counter >= 2)
        {
    ...
    {
        SW_G[1].Lock--;
    }else if(!GPIO_GetPinState((((GPIO_TypeDef*)&PORTB)), (1)))
    {
        SW_G[1].Counter++;
        if(SW_G[1].Counter >= 2)
        {
    ...
    {
        SW_G[2].Lock--;
    }else if(!GPIO_GetPinState((((GPIO_TypeDef*)&PORTB)), (2)))
    {
        SW_G[2].Counter++;
        if(SW_G[2].Counter >= 2)
        {
