...
void LED_Init(void)
{
    LED_G[0].State = 0;
    LED_G[1].State = 0;
    GPIO_InitPin((((GPIO_TypeDef*)&PORTB)), (7), (0));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTB)), (6), (0));
}

void LED_Update(void)
{
    GPIO_SetPinState((((GPIO_TypeDef*)&PORTB)), (7), LED_G[0].State);
    GPIO_SetPinState((((GPIO_TypeDef*)&PORTB)), (6), LED_G[1].State);
}
