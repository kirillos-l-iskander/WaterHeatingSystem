...
void SSD_Init(void)
{
    ...
    SSD_G[3].State = 0;
    SSD_G[3].Symbol = 0;
    GPIO_InitPin((((GPIO_TypeDef*)&PORTD)), (0), (0));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTD)), (1), (0));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTD)), (2), (0));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTD)), (3), (0));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTD)), (4), (0));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTD)), (5), (0));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTD)), (6), (0));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTD)), (7), (0));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTA)), (5), (0));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTA)), (4), (0));
}

void SSD_Update(void)
{
    GPIO_SetPinState((((GPIO_TypeDef*)&PORTA)), (5), (0));
    GPIO_SetPinState((((GPIO_TypeDef*)&PORTA)), (4), (0));
    GPIO_SetPortState((((GPIO_TypeDef*)&PORTD)), 0xFF, SSD_SymbolPattern_G[SSD_G[SSD_Num_G].Symbol]);
    if(SSD_Num_G == 0)
    {
        GPIO_SetPinState((((GPIO_TypeDef*)&PORTA)), (5), SSD_G[0].State);
    }
    if(SSD_Num_G == 1)
    {
        GPIO_SetPinState((((GPIO_TypeDef*)&PORTA)), (4), SSD_G[1].State);
    }
    SSD_Num_G++;
    if(SSD_Num_G == 2)
    {
