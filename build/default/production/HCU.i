...
void HCU_Init(void)
{
    HCU_G[0].State = 0;
    HCU_G[1].State = 0;
    GPIO_InitPin((((GPIO_TypeDef*)&PORTC)), (5), (0));
    GPIO_InitPin((((GPIO_TypeDef*)&PORTC)), (2), (0));
}

void HCU_Update(void)
{
    GPIO_SetPinState((((GPIO_TypeDef*)&PORTC)), (5), HCU_G[0].State);
    GPIO_SetPinState((((GPIO_TypeDef*)&PORTC)), (2), HCU_G[1].State);
}
